...
public class AppServiceTest {
    ...
    public void returnTrueWhenSuccessfullyCompressedLzw() throws IOException {
        ...
        mockStatic(Io.class);
        when(Io.writeBytesToFile(targetFile, mockList)).thenReturn(true);
    ...
    public void returnFalseWithFailedCompressionWithLzw() throws IOException {
        ...
        mockStatic(Io.class);
        when(Io.writeStringToFile(targetFile, "compressed")).thenReturn(false);
    ...
    public void returnFalseWithFailedDecompressionWithLzw() throws IOException {
        ...
        mockStatic(Io.class);
        when(Io.writeStringToFile(targetFile, "")).thenReturn(false);
    ...
    public void returnTrueWithSuccessfulDecompressionWithLzw() throws IOException {
        ...
        when(Io.writeStringToFile(targetFile, "success")).thenReturn(true);
