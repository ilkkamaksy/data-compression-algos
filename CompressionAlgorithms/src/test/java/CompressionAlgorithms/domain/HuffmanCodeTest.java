...
public class HuffmanCodeTest {
    ...
    public void testEncodeAlphabets() {
        ...
        String expResult = "[48, 48, 48, 48, 115, 110, 48, 113, 97, 48, 48, 114, 111, 48, 117, 109, 48, 48, 48, 48, 121, 44, 48, 118, 108, 48, 48, 119, 100, 48, 116, 101, 48, 48, 48, 32, 122, 48, 48, 105, 99, 48, 103, 46, 48, 48, 48, 112, 102, 48, 120, 63, 48, 48, 98, 104, 48, 106, 107, 35, 63, 53, -83, -7, -37, -35, 62, -2, 110, 43, -63, 32, 89, -91, 78, -95, -100, 111, 30, -64]";
        List<Byte> encoded = HuffmanCode.encode(inputStr);
    ...
    public void testDecodeAlphabets() {
        ...
        String expResult = "abcdefghijklmnopqrstuvwxyz .,?s";
        String result = HuffmanCode.decode(encoded);
